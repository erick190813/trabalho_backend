...
const storage = multer.diskStorage({
    ...
    filename: (req, file, cb) => {
        // Renomeando o arquivo de imagem exemplo: (imagem.jpg => 17583484.jpg)
...
// Rota para acessar dados so JSON produtos / index
router.get('/', (req, res) => {
    const data = lerDados();
    res.json(data);
});
            ...
            if (req.file) {
                ...
                if (produto_edit.img_produto) {
                    ...
                    fs.unlink(img_antiga, (erro) => {
                        ...
                        if (erro) {
                            console.erro("Erro ao tentar excluir a imagem antiga!", erro)
                        } else {
                            console.log("Imagem antiga excluida com sucesso!", img_antiga)
                        }
        ...
        if (img_del.img_produto) {
            ...
            fs.unlink(imagePath, (erro) => {
                ...
                if (erro) {
                    ...
                    console.log("Imagem antiga excluida com sucesso!", imagePath)
                }
